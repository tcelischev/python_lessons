...
# ================
'''  
1. создать файл, режим запись.
2. написать генератор числа из N цифр (int(0-1*100)). 
3. записать число в файл. Закрыть файл
4. Открыть файл на чтение.
5. написать алгоритм поиска подряд одинаковых цифр. Счетчик длины последовательности
'''
